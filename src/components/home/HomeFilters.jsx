...
export default function HomeFilters () {
    ...
    const shortcount = 5; // сколько категорий видно сразу 
    ...
    return (
        <div class="project-header">
			...
			<div class="project-header__links _active">
                ...
                {
                    !isOpen && 
                    <span class="project-header__link hover-transformproject-header__link_border pointer project-header__link-all" onClick={() => setIsOpen(true)}>
                        + Всё
                    </span>
                }
				{
